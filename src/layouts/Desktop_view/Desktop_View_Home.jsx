...
const DesktopViewHome = () => {
  ...
  const handleOpenRedirect = () => {
    if (selectedAd?.redirect_url) {
      window.open(selectedAd.redirect_url, "_blank", "noopener,noreferrer");
    }
  };
  ...
  return (
    <>
        ...
        <div className="hero-left">
          {homeVideoUrl ? (
            ...
            <div className="no-banner-placeholder">
              <img
                src="/images/default-hero-banner.jpg"
                alt="Welcome to Signpost Phonebook"
      ...
      {/* POPULAR SEARCHES - Red */}
      <section className="popular-searches">
        <div className="popular-layout">
          <div className="popular-heading-card red">
            <h2>Top Picks<br />This Week</h2>
            <p>See what everyone is searching for right now</p>
          </div>
      ...
      {/* POPULAR SEARCHES - Green */}
      <section className="popular-searches">
        <div className="popular-layout">
          <div className="popular-heading-card green">
            <h2>High Demand<br />Categories</h2>
            <p>Popular services people need the most</p>
          </div>
      ...
      {/* ─── AD TARGET MODAL ──────────────────────────────── */}
      {selectedAd && (
        <div className="ad-modal-overlay" onClick={closeAdModal}>
          <div className="ad-modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              {selectedAd.redirect_url ? (
                isImageUrl(selectedAd.redirect_url) ? (
                  <div className="modal-image-container">
                    <img
                      src={selectedAd.redirect_url}
                      alt="Target content"
                      className="modal-target-image"
                      onError={(e) => {
                        e.target.src = "/images/fallback-large.jpg";
                      }}
                    />
                  </div>
                ) : (
                  <div className="modal-link-fallback">
                    <h3>Advertisement Link</h3>
                    <p className="redirect-url-text">{selectedAd.redirect_url}</p>
                    <button
                ...
                <div className="no-redirect">
                  <p>No redirect link available for this advertisement.</p>
                </div>
              )}
            </div>
          </div>
